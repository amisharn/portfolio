    ...
    <section className="min-h-screen px-6 sm:px-10 py-12">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8">
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal tracking-[-0.05em] leading-none mt-4 sm:mt-8 mb-6 sm:mb-8">
            amisha raj n.
          </h1>
        ...
        {/* Right */}
        <div className="w-full lg:w-1/2">
          <p className="-rotate-6 font-abramo text-2xl sm:text-3xl md:text-4xl lg:text-5xl uppercase tracking-[0.2em] sm:tracking-[0.3em] text-gray-400 mt-8 lg:mt-16 mb-8 lg:mb-8">
            About Me
          </p>
